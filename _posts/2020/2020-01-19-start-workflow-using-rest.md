...
subtitle:
description: Learn how to start a workflow using the REST API.
image:
...
###### Sample Output
![2010 Workflow Information](/assets/posts/start-workflow/wf2010info.png)
...
###### Sample Output
![2013 Workflow Information](/assets/posts/start-workflow/wf2013info.png)
